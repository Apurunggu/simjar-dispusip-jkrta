...
<body>
    ...
    <div style="text-align:center;">
        ...
        Tanggal: <?php echo e(date('d F Y')); ?><br>
    </div>
    <div class="mt-20"></div>
    <table class="table">
        <thead>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $barangMasuk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e($item->nomor_barang ?? '-'); ?></td>
                    <td><?php echo e($item->nama_barang ?? '-'); ?></td>
                    <td><?php echo e($item->kategori ?? '-'); ?></td>
                    <td><?php echo e($item->jumlah ?? '-'); ?></td>
                    <td>
                        <?php if(isset($item->tanggal_masuk)): ?>
                            <?php if($item->tanggal_masuk instanceof \Carbon\Carbon): ?>
                                <?php echo e($item->tanggal_masuk->format('d-m-Y')); ?>
    ...
    <div class="signature">
        <table style="width:100%; margin-top:40px;">
            <tr>
                ...
                <td style="width:50%; text-align:center;">Petugas,<br><br><br><br><u><?php echo e(auth()->user()->name ?? '-'); ?></u><br>NIP. <?php echo e(auth()->user()->nip ?? '-'); ?></td>
            </tr>
        </table>
    </div>
...
<?php /**PATH C:\xampp\htdocs\Simjar_dispusip\resources\views/barang_masuk/pdf.blade.php ENDPATH**/ ?>