...
<div class="card shadow-sm">
    <div class="card-body">
        <div class="mb-4 d-flex justify-content-between align-items-center">
            <h2 class="card-title"><i class="bi bi-file-earmark-text"></i> Dokumen Barang Pihak ke 2</h2>
        ...
        <form method="GET" class="mb-3 d-flex gap-2">
            <input type="search" name="q" value="{{ request('q') }}" class="form-control" placeholder="Cari nama dokumen / file...">
            <button type="submit" class="btn btn-outline-primary">Search</button>
            @if(request()->filled('q'))
                <a href="{{ route('dokumen-barang-pihak2.index') }}" class="btn btn-outline-secondary">Reset</a>
            @endif
        </form>
