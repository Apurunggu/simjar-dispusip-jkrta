...
<div class="mb-4 d-flex justify-content-between align-items-center" style="gap:16px;">
    ...
    <a href="{{ route('laporan-ttd.create') }}" class="btn btn-primary btn-custom" style="height:40px; display:flex; align-items:center;">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column">
                ...
                <div class="mt-auto">
                    <a href="{{ route('laporan-ttd.download', $laporan->id) }}" class="btn btn-sm btn-primary w-100">
